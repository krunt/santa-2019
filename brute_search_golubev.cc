...
constexpr array<uint8_t, 11> DISTRIBUTION{2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 4}; // You can setup how many families you need for swaps and what best choice use for each family
